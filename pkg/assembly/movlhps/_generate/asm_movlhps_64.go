...
//go:generate go run asm_movlhps_64.go -out ../asm_movlhps_64.s -stubs ../stub_movlhps_64.go -pkg movlhps
func main() {
	TEXT("movlhps64", NOSPLIT, "func(vals *[2]float32, ret *[2]float32)")
	Comment("load params")
