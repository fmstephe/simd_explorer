...
//go:generate go run asm_vpsrlq_128.go -out ../asm_vpsrlq_128.s -stubs ../stub_vpsrlq_128.go -pkg psrl
func main() {
	TEXT("vpsrlq128", NOSPLIT, "func(vals *[2]uint64, shift *[2]uint64, ret *[2]uint64)")
	Comment("load params")
