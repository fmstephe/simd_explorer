...
//go:generate go run asm_vpsrld_128.go -out ../asm_vpsrld_128.s -stubs ../stub_vpsrld_128.go -pkg psrl
func main() {
	TEXT("vpsrld128", NOSPLIT, "func(vals *[4]uint32, shift *[2]uint64, ret *[4]uint32)")
	Comment("load params")
