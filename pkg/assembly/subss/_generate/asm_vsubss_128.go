...
//go:generate go run asm_vsubss_128.go -out ../asm_vsubss_128.s -stubs ../stub_vsubss_128.go -pkg subss
func main() {
	TEXT("vsubss128", NOSPLIT, "func(vals1, vals2 *[4]float32, ret *[4]float32)")
	Comment("load params")
