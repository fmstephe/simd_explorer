...
//go:generate go run asm_vpsignw_128.go -out ../asm_vpsignw_128.s -stubs ../stub_vpsignw_128.go -pkg vpsign
func main() {
	TEXT("vpsignw128", NOSPLIT, "func(vals1 *[8]int16,  vals2 *[8]int16,  ret *[8]int16)")
	Comment("load params")
