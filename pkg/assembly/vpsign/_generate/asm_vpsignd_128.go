...
//go:generate go run asm_vpsignd_128.go -out ../asm_vpsignd_128.s -stubs ../stub_vpsignd_128.go -pkg vpsign
func main() {
	TEXT("vpsignd128", NOSPLIT, "func(vals1 *[4]int32,  vals2 *[4]int32,  ret *[4]int32)")
	Comment("load params")
