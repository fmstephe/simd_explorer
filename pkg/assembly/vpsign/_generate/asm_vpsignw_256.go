...
//go:generate go run asm_vpsignw_256.go -out ../asm_vpsignw_256.s -stubs ../stub_vpsignw_256.go -pkg vpsign
func main() {
	TEXT("vpsignw256", NOSPLIT, "func(vals1 *[16]int16, vals2 *[16]int16, ret *[16]int16)")
	Comment("load params")
