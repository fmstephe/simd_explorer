...
//go:generate go run asm_vpsignb_128.go -out ../asm_vpsignb_128.s -stubs ../stub_vpsignb_128.go -pkg vpsign
func main() {
	TEXT("vpsignb128", NOSPLIT, "func(vals1 *[16]int8,  vals2 *[16]int8,  ret *[16]int8)")
	Comment("load params")
