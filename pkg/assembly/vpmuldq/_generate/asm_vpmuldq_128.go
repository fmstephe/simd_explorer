...
//go:generate go run asm_vpmuldq_128.go -out ../asm_vpmuldq_128.s -stubs ../stub_vpmuldq_128.go -pkg vpmuldq
func main() {
	TEXT("vpmuldq128", NOSPLIT, "func(vals1 *[4]int32,  vals2 *[4]int32,  ret *[2]int64)")
	Comment("load params")
