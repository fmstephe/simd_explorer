...
//go:generate go run asm_vpmuldq_256.go -out ../asm_vpmuldq_256.s -stubs ../stub_vpmuldq_256.go -pkg vpmuldq
func main() {
	TEXT("vpmuldq256", NOSPLIT, "func(vals1 *[8]int32,  vals2 *[8]int32,  ret *[4]int64)")
	Comment("load params")
