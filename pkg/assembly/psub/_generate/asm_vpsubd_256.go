...
//go:generate go run asm_vpsubd_256.go -out ../asm_vpsubd_256.s -stubs ../stub_vpsubd_256.go -pkg psub
func main() {
	TEXT("vpsubd256", NOSPLIT, "func(vals1 *[8]uint32, vals2 *[8]uint32, ret *[8]uint32)")
	Comment("load params")
