...
//go:generate go run asm_vpsubq_128.go -out ../asm_vpsubq_128.s -stubs ../stub_vpsubq_128.go -pkg psub
func main() {
	TEXT("vpsubq128", NOSPLIT, "func(vals1 *[2]uint64, vals2 *[2]uint64, ret *[2]uint64)")
	Comment("load params")
