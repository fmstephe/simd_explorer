...
//go:generate go run asm_vaddsubps_256.go -out ../asm_vaddsubps_256.s -stubs ../stub_vaddsubps_256.go -pkg vaddsubps
func main() {
	TEXT("vaddsubps256", NOSPLIT, "func(vals1 *[8]float32, vals2 *[8]float32, ret *[8]float32)")
	Comment("load params")
