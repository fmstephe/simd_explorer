...
//go:generate go run asm_vpsrlvd_256.go -out ../asm_vpsrlvd_256.s -stubs ../stub_vpsrlvd_256.go -pkg vpsrlvd
func main() {
	TEXT("vpsrlvd256", NOSPLIT, "func(vals *[8]uint32, shifts *[8]uint32, ret *[8]uint32)")
	Comment("load params")
