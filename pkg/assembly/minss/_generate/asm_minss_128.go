...
//go:generate go run asm_minss_128.go -out ../asm_minss_128.s -stubs ../stub_minss_128.go -pkg minss
func main() {
	TEXT("minss128", NOSPLIT, "func(vals1, vals2 *[4]float32, ret *[4]float32)")
	Comment("load params")
