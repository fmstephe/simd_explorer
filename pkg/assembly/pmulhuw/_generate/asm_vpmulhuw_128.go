...
func main() {
	TEXT("vpmulhuw128", NOSPLIT, "func(vals1 *[8]uint16, vals2 *[8]uint16, ret *[8]uint16)")
	Comment("load params")
	...
	Comment("Multiply packed unsigned 16-bit integers; keep high 16 bits of 32-bit products")
