...
func NewVPERM2F128128HIGHA_HIGHA() *VPERM2F128128HIGHA_HIGHA {
	return &VPERM2F128128HIGHA_HIGHA{
...
func (v *VPERM2F128128HIGHA_HIGHA) Run(_ [][]byte) (output []byte) {
	valsA := [8]float32{}
	...
	vperm2f128128Higha_higha(&valsA, &valsB, &ret)

	log.Printf("VPERM2F128128HIGHA_HIGHA A %v B %v output %v", valsA, valsB, ret)
