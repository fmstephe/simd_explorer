...
func NewVPERM2F128128ZEROED_HIGHB() *VPERM2F128128ZEROED_HIGHB {
	return &VPERM2F128128ZEROED_HIGHB{
...
func (v *VPERM2F128128ZEROED_HIGHB) Run(_ [][]byte) (output []byte) {
	valsA := [8]float32{}
	...
	vperm2f128128Zeroed_highb(&valsA, &valsB, &ret)

	log.Printf("VPERM2F128128ZEROED_HIGHB A %v B %v output %v", valsA, valsB, ret)
