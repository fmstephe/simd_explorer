...
func NewVPERM2F128128HIGHB_HIGHB() *VPERM2F128128HIGHB_HIGHB {
	return &VPERM2F128128HIGHB_HIGHB{
...
func (v *VPERM2F128128HIGHB_HIGHB) Run(_ [][]byte) (output []byte) {
	valsA := [8]float32{}
	...
	vperm2f128128Highb_highb(&valsA, &valsB, &ret)

	log.Printf("VPERM2F128128HIGHB_HIGHB A %v B %v output %v", valsA, valsB, ret)
