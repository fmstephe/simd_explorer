...
//go:generate go run asm_vperm2f128_128_lowa_highb.go -out ../asm_vperm2f128_128_lowa_highb.s -stubs ../stub_vperm2f128_128_lowa_highb.go -pkg vperm2f128
func main() {
	TEXT("vperm2f128128Lowa_highb", NOSPLIT, "func(valsA, valsB, ret *[8]float32)")
	Comment("load params")
