...
//go:generate go run asm_vperm2f128_256_higha_higha.go -out ../asm_vperm2f128_256_higha_higha.s -stubs ../stub_vperm2f128_256_higha_higha.go -pkg vperm2f128
func main() {
	TEXT("vperm2f128256Higha_higha", NOSPLIT, "func(valsA, valsB, ret *[8]float32)")
	Comment("load params")
