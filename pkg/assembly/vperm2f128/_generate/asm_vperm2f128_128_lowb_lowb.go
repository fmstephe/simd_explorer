...
//go:generate go run asm_vperm2f128_128_lowb_lowb.go -out ../asm_vperm2f128_128_lowb_lowb.s -stubs ../stub_vperm2f128_128_lowb_lowb.go -pkg vperm2f128
func main() {
	TEXT("vperm2f128128Lowb_lowb", NOSPLIT, "func(valsA, valsB, ret *[8]float32)")
	Comment("load params")
