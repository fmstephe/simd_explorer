...
func NewVPERM2F128128LOWA_HIGHB() *VPERM2F128128LOWA_HIGHB {
	return &VPERM2F128128LOWA_HIGHB{
...
func (v *VPERM2F128128LOWA_HIGHB) Run(_ [][]byte) (output []byte) {
	valsA := [8]float32{}
	...
	vperm2f128128Lowa_highb(&valsA, &valsB, &ret)

	log.Printf("VPERM2F128128LOWA_HIGHB A %v B %v output %v", valsA, valsB, ret)
