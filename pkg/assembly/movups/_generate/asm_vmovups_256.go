...
//go:generate go run asm_vmovups_256.go -out ../asm_vmovups_256.s -stubs ../stub_vmovups_256.go -pkg movups
func main() {
	TEXT("vmovups256", NOSPLIT, "func(vals *[8]float32, ret *[8]float32)")
