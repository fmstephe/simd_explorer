...
//go:generate go run asm_vcomiss_128.go -out ../asm_vcomiss_128.s -stubs ../stub_vcomiss_128.go -pkg comiss
func main() {
	TEXT("vcomiss128", NOSPLIT, "func(vals1, vals2 *[4]float32) (flags uint32)")
	Comment("load params")
