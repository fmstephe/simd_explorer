...
//go:generate go run asm_comiss_128.go -out ../asm_comiss_128.s -stubs ../stub_comiss_128.go -pkg comiss
func main() {
	TEXT("comiss128", NOSPLIT, "func(vals1, vals2 *[4]float32) (flags uint32)")
	Comment("load params")
