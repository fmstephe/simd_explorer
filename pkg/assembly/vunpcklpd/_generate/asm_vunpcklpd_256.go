...
//go:generate go run asm_vunpcklpd_256.go -out ../asm_vunpcklpd_256.s -stubs ../stub_vunpcklpd_256.go -pkg vunpcklpd
func main() {
	TEXT("vunpcklpd256", NOSPLIT, "func(vals1 *[4]float64,  vals2 *[4]float64,  ret *[4]float64)")
	Comment("load params")
