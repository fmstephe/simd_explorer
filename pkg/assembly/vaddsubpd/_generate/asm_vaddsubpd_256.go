...
//go:generate go run asm_vaddsubpd_256.go -out ../asm_vaddsubpd_256.s -stubs ../stub_vaddsubpd_256.go -pkg vaddsubpd
func main() {
	TEXT("vaddsubpd256", NOSPLIT, "func(vals1 *[4]float64, vals2 *[4]float64, ret *[4]float64)")
	Comment("load params")
