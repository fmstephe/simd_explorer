...
//go:generate go run asm_addss_128.go -out ../asm_addss_128.s -stubs ../stub_addss_128.go -pkg addss
func main() {
	TEXT("addss128", NOSPLIT, "func(vals1, vals2 *[4]float32, ret *[4]float32)")
	Comment("load params")
