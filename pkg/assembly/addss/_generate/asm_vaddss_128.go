...
//go:generate go run asm_vaddss_128.go -out ../asm_vaddss_128.s -stubs ../stub_vaddss_128.go -pkg addss
func main() {
	TEXT("vaddss128", NOSPLIT, "func(vals1, vals2 *[4]float32, ret *[4]float32)")
	Comment("load params")
