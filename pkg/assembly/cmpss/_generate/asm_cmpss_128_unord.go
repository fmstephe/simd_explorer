...
//go:generate go run asm_cmpss_128_unord.go -out ../asm_cmpss_128_unord.s -stubs ../stub_cmpss_128_unord.go -pkg cmpss
func main() {
	TEXT("cmpss128Unord", NOSPLIT, "func(vals1, vals2, ret *[4]float32)")
	Comment("load params")
	...
	CMPSS(regX2, regX1, U8(3)) // 3 = UNORD
