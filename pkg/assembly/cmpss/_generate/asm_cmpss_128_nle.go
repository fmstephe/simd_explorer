...
//go:generate go run asm_cmpss_128_nle.go -out ../asm_cmpss_128_nle.s -stubs ../stub_cmpss_128_nle.go -pkg cmpss
func main() {
	...
	TEXT("cmpss128Nle", NOSPLIT, "func(vals1, vals2, ret *[4]float32)")
	Comment("load params")
