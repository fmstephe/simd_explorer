...
//go:generate go run asm_cmpss_128_nlt.go -out ../asm_cmpss_128_nlt.s -stubs ../stub_cmpss_128_nlt.go -pkg cmpss
func main() {
	...
	TEXT("cmpss128Nlt", NOSPLIT, "func(vals1, vals2, ret *[4]float32)")
	Comment("load params")
