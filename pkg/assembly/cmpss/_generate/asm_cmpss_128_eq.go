...
//go:generate go run asm_cmpss_128_eq.go -out ../asm_cmpss_128_eq.s -stubs ../stub_cmpss_128_eq.go -pkg cmpss
func main() {
	...
	TEXT("cmpss128Eq", NOSPLIT, "func(vals1, vals2, ret *[4]float32)")
	Comment("load params")
