...
func NewVSHUFPS128ZEROS() *VSHUFPS128ZEROS {
	return &VSHUFPS128ZEROS{
...
func (v *VSHUFPS128ZEROS) Run(_ [][]byte) (output []byte) {
	vals1 := [4]float32{}
	...
	vshufps128Zeros(&vals1, &vals2, &ret)

	log.Printf("VSHUFPS128ZEROS input %v %v output %v", vals1, vals2, ret)
