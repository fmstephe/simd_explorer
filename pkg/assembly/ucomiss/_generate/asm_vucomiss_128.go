...
//go:generate go run asm_vucomiss_128.go -out ../asm_vucomiss_128.s -stubs ../stub_vucomiss_128.go -pkg ucomiss
func main() {
	TEXT("vucomiss128", NOSPLIT, "func(vals1, vals2 *[4]float32) (flags uint32)")
	Comment("load params")
