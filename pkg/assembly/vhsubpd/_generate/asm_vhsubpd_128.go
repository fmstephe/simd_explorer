...
//go:generate go run asm_vhsubpd_128.go -out ../asm_vhsubpd_128.s -stubs ../stub_vhsubpd_128.go -pkg vhsubpd
func main() {
	TEXT("vhsubpd128", NOSPLIT, "func(vals1 *[2]float64, vals2 *[2]float64, ret *[2]float64)")
	Comment("load params")
