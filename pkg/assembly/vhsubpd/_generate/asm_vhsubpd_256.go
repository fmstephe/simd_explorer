...
//go:generate go run asm_vhsubpd_256.go -out ../asm_vhsubpd_256.s -stubs ../stub_vhsubpd_256.go -pkg vhsubpd
func main() {
	TEXT("vhsubpd256", NOSPLIT, "func(vals1 *[4]float64, vals2 *[4]float64, ret *[4]float64)")
	Comment("load params")
