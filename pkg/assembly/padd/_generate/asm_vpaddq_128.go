...
//go:generate go run asm_vpaddq_128.go -out ../asm_vpaddq_128.s -stubs ../stub_vpaddq_128.go -pkg padd
func main() {
	TEXT("vpaddq128", NOSPLIT, "func(vals1 *[2]uint64, vals2 *[2]uint64, ret *[2]uint64)")
	Comment("load params")
