...
//go:generate go run asm_vpaddb_256.go -out ../asm_vpaddb_256.s -stubs ../stub_vpaddb_256.go -pkg padd
func main() {
	TEXT("vpaddb256", NOSPLIT, "func(vals1 *[32]uint8, vals2 *[32]uint8, ret *[32]uint8)")
	Comment("load params")
