...
//go:generate go run asm_vblendvpw_256.go -out ../asm_vblendvpw_256.s -stubs ../stub_vblendvpw_256.go -pkg blendvpw
func main() {
	TEXT("vblendvpw256", NOSPLIT, "func(base *[16]uint16, blend *[16]uint16, mask *[16]uint16, ret *[16]uint16)")
	Comment("load params")
