...
//go:generate go run asm_vpsllq_256.go -out ../asm_vpsllq_256.s -stubs ../stub_vpsllq_256.go -pkg psll
func main() {
	TEXT("vpsllq256", NOSPLIT, "func(vals *[4]uint64, shift *[4]uint64, ret *[4]uint64)")
	Comment("load params")
