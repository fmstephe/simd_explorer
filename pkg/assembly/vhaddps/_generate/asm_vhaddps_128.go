...
//go:generate go run asm_vhaddps_128.go -out ../asm_vhaddps_128.s -stubs ../stub_vhaddps_128.go -pkg vhaddps
func main() {
	TEXT("vhaddps128", NOSPLIT, "func(vals1 *[4]float32, vals2 *[4]float32, ret *[4]float32)")
	Comment("load params")
