...
func NewCMPPS128NEQ() *CMPPS128NEQ {
	return &CMPPS128NEQ{
...
func (v *CMPPS128NEQ) Run(_ [][]byte) (output []byte) {
	vals1 := [4]float32{}
	...
	cmpps128Neq(&vals1, &vals2, &ret)

	log.Printf("CMPPS128NEQ input %v %v output %v", vals1, vals2, ret)
