...
//go:generate go run asm_vhaddpd_256.go -out ../asm_vhaddpd_256.s -stubs ../stub_vhaddpd_256.go -pkg vhaddpd
func main() {
	TEXT("vhaddpd256", NOSPLIT, "func(vals1 *[4]float64, vals2 *[4]float64, ret *[4]float64)")
	Comment("load params")
