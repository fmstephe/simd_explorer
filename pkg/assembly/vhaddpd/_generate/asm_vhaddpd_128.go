...
//go:generate go run asm_vhaddpd_128.go -out ../asm_vhaddpd_128.s -stubs ../stub_vhaddpd_128.go -pkg vhaddpd
func main() {
	TEXT("vhaddpd128", NOSPLIT, "func(vals1 *[2]float64, vals2 *[2]float64, ret *[2]float64)")
	Comment("load params")
