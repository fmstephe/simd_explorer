...
//go:generate go run asm_vblendpd_256_none.go -out ../asm_vblendpd_256_none.s -stubs ../stub_vblendpd_256_none.go -pkg blendpd
func main() {
	TEXT("vblendpd256None", NOSPLIT, "func(base *[4]float64, blend *[4]float64, ret *[4]float64)")
	Comment("load params")
	...
	Comment("VBLENDPD 256: imm=0x00 selects all lanes from base")
