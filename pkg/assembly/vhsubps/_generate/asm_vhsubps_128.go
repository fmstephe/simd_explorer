...
//go:generate go run asm_vhsubps_128.go -out ../asm_vhsubps_128.s -stubs ../stub_vhsubps_128.go -pkg vhsubps
func main() {
	TEXT("vhsubps128", NOSPLIT, "func(vals1 *[4]float32, vals2 *[4]float32, ret *[4]float32)")
	Comment("load params")
