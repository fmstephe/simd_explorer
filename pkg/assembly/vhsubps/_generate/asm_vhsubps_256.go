...
//go:generate go run asm_vhsubps_256.go -out ../asm_vhsubps_256.s -stubs ../stub_vhsubps_256.go -pkg vhsubps
func main() {
	TEXT("vhsubps256", NOSPLIT, "func(vals1 *[8]float32, vals2 *[8]float32, ret *[8]float32)")
	Comment("load params")
