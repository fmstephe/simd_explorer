...
//go:generate go run asm_vpsrlvq_256.go -out ../asm_vpsrlvq_256.s -stubs ../stub_vpsrlvq_256.go -pkg vpsrlvq
func main() {
	TEXT("vpsrlvq256", NOSPLIT, "func(vals *[4]uint64, shifts *[4]uint64, ret *[4]uint64)")
	Comment("load params")
