...
//go:generate go run asm_vpunpcklbw_256.go -out ../asm_vpunpcklbw_256.s -stubs ../stub_vpunpcklbw_256.go -pkg punpckl
func main() {
	TEXT("vpunpcklbw256", NOSPLIT, "func(vals1 *[32]uint8, vals2 *[32]uint8, ret *[32]uint8)")
	Comment("load params")
