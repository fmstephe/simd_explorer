...
//go:generate go run asm_vshufpd_256_lowa_lowb.go -out ../asm_vshufpd_256_lowa_lowb.s -stubs ../stub_vshufpd_256_lowa_lowb.go -pkg vshufpd
func main() {
	TEXT("vshufpd256Lowa_lowb", NOSPLIT, "func(vals1 *[4]float64,  vals2 *[4]float64,  ret *[4]float64)")
	Comment("load params")
	...
	VSHUFPD(Imm(0x00), vals2Y, vals1Y, retY)
