...
//go:generate go run asm_vpmuludq_256.go -out ../asm_vpmuludq_256.s -stubs ../stub_vpmuludq_256.go -pkg pmuludq
func main() {
	TEXT("vpmuludq256", NOSPLIT, "func(vals1 *[8]uint32, vals2 *[8]uint32, ret *[4]uint64)")
	Comment("load params")
