...
//go:generate go run asm_vpsrad_128.go -out ../asm_vpsrad_128.s -stubs ../stub_vpsrad_128.go -pkg psra
func main() {
	TEXT("vpsrad128", NOSPLIT, "func(vals *[4]int32, shift *[2]uint64, ret *[4]int32)")
	Comment("load params")
