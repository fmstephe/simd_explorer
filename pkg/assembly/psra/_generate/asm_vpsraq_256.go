...
//go:generate go run asm_vpsraq_256.go -out ../asm_vpsraq_256.s -stubs ../stub_vpsraq_256.go -pkg psra
func main() {
	TEXT("vpsraq256", NOSPLIT, "func(vals *[4]int64, shift *[4]uint64, ret *[4]int64)")
	Comment("load params")
