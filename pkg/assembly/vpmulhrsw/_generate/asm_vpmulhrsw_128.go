...
//go:generate go run asm_vpmulhrsw_128.go -out ../asm_vpmulhrsw_128.s -stubs ../stub_vpmulhrsw_128.go -pkg vpmulhrsw
func main() {
	TEXT("vpmulhrsw128", NOSPLIT, "func(vals1 *[8]int16, vals2 *[8]int16, ret *[8]int16)")
	Comment("load params")
